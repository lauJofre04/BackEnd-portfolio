...
import com.portfolio.jofre.Service.SExperiencia;
...
@CrossOrigin(origins="https://frontend-jofrelautaro.web.app",exposedHeaders = {"Access-Control-Allow-Origin","Access-Control-Allow-Credentials"})//direccion del front de angular
